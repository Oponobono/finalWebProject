                ...
                <div class="col-md-3">
                    <h1 class="oswald d-flex justify-content-center mb-3">Ingrese datos de Venta</h1>
                        <form action="sales.php" method="POST">
                            ...
                            <input type="number" class="form-control mb-3" name="id_cliente" placeholder="ID Cliente">
                            <input type="text" class="form-control mb-3" name="nombre_venta" placeholder="Nombre">
                            <input type="number" class="form-control mb-3" pattern="[0-9]+" name="cantidad" placeholder="Cantidad">
                            <input type="number" step="0.01" class="form-control mb-3" pattern="[0-9]+" name="total_venta" placeholder="Total Venta">
