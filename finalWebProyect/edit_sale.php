    ...
    <body>
            <div class="container mt-5">
                <form action="edit_sale.php?id=<?php echo $_GET['id']; ?>" method="POST">
                            ...
                            <input type="text" class="form-control mb-3" name="id_cliente" placeholder="ID Clinte" value="<?php echo $row['id_cliente']?>">
                            ...
                            <input type="text" class="form-control mb-3" name="total_venta" placeholder="Total Venta" value="<?php echo $row['total_venta']?>">
