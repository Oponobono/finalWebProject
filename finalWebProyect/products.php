                    ...
                    <div class="col-md-3">
                        <h1 class="oswald d-flex justify-content-center mb-3">Ingrese datos de Producto</h1>
                            <form action="products.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="valor_compra_producto" placeholder="Valor de Compra">
                                <input type="text" class="form-control mb-3" name="valor_venta_producto" placeholder="Valor de Venta">
