    ...
    <body>
            <div class="container mt-5">
                <form action="edit_product.php?id=<?php echo $_GET['id']; ?>" method="POST">
                            ...
                            <input type="number" step="0.01" class="form-control mb-3" name="valor_compra_producto" placeholder="Valor Compra" value="<?php echo $row['valor_compra_producto']?>">
                            <input type="number" step="0.01" class="form-control mb-3" name="valor_venta_producto" placeholder="Valor Venta" value="<?php echo $row['valor_venta_producto']?>">
